...
public class AddNewChart_Activity extends Base_Activity {
  ...
  private void getChartsBySection(String sectionName, final int requestCodeToSendBack) {
    DataAccessHandler.getInstance()
        .getChartsBySection(prefs.getString(Constants.PREF_USER_ACCESS_TOKEN,
            Constants.NO_ACCESS_TOKEN_FOUND_IN_PREFS), sectionName,
            new Callback<ChartsBySectionResponse>() {
                ...
                switch (response.code()) {
                  case 200:
                    ...
                    chartsList.setAdapter(
                        new DataChartsListing_Adapter(AddNewChart_Activity.this, chartItemsMap));
                    ...
                    chartsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                      ...
                      public void onItemClick(AdapterView<?> adapterView, View view, int position,
                        ...
                        if (!dataChart.getName().equals("Number of Steps")) {
                          ...
                          intent.putExtra(Constants.EXTRAS_CHART_TYPE_SELECTED,
                              dataChart.getType());
  ...
  private void addMetricChart(int chart_id) {
    DataAccessHandler.getInstance()
        .addMetricChart(prefs.getString(Constants.PREF_USER_ACCESS_TOKEN,
