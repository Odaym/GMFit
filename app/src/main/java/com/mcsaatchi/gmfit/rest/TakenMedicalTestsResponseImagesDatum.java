...
public class TakenMedicalTestsResponseImagesDatum implements Parcelable {
  public static final Creator<TakenMedicalTestsResponseImagesDatum> CREATOR =
      new Creator<TakenMedicalTestsResponseImagesDatum>() {
        @Override public TakenMedicalTestsResponseImagesDatum createFromParcel(Parcel source) {
          return new TakenMedicalTestsResponseImagesDatum(source);
        }

        @Override public TakenMedicalTestsResponseImagesDatum[] newArray(int size) {
