...
public class TakenMedicalTestsResponseUnit implements Parcelable{
    public static final Creator<TakenMedicalTestsResponseUnit> CREATOR = new Creator<TakenMedicalTestsResponseUnit>() {
        @Override
        public TakenMedicalTestsResponseUnit createFromParcel(Parcel source) {
            return new TakenMedicalTestsResponseUnit(source);
        }

        @Override
        public TakenMedicalTestsResponseUnit[] newArray(int size) {
