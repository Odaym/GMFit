...
public class TakenMedicalTestsResponseBody implements Parcelable {
    public static final Creator<TakenMedicalTestsResponseBody> CREATOR = new Creator<TakenMedicalTestsResponseBody>() {
        @Override
        public TakenMedicalTestsResponseBody createFromParcel(Parcel source) {
            return new TakenMedicalTestsResponseBody(source);
        }

        @Override
        public TakenMedicalTestsResponseBody[] newArray(int size) {
    ...
    @Expose
    private List<TakenMedicalTestsResponseImagesDatum> images = new ArrayList<>();
