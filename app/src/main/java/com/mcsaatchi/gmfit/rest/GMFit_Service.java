...
public interface GMFit_Service {
  ...
  @GET Call<UiResponse> getUiForSection(
      @Header(Constants.USER_ACCESS_TOKEN_HEADER_PARAMETER) String userAccessToken,
      @Url String fullUrl);
  ...
  @GET Call<ChartsBySectionResponse> getChartsBySection(
      @Header(Constants.USER_ACCESS_TOKEN_HEADER_PARAMETER) String userAccessToken,
      @Url String fullUrl);

  @GET("meals") Call<SearchMealItemResponse> searchForMeals(
      @Header(Constants.USER_ACCESS_TOKEN_HEADER_PARAMETER) String userAccessToken,
  ...
  @GET Call<RecentMealsResponse> getRecentMeals(
      @Header(Constants.USER_ACCESS_TOKEN_HEADER_PARAMETER) String userAccessToken,
      @Url String fullUrl);
  ...
  @Multipart @POST("user/medical/store") Call<DefaultGetResponse> storeNewHealthTest(
      @Header(Constants.USER_ACCESS_TOKEN_HEADER_PARAMETER) String userAccessToken,
      @Part("test_slug") RequestBody test_slug, @Part("date_taken") RequestBody date_taken,
