...
public class UserProfileResponseGoal implements Parcelable {
    public static final Creator<UserProfileResponseGoal> CREATOR = new Creator<UserProfileResponseGoal>() {
        @Override
        public UserProfileResponseGoal createFromParcel(Parcel source) {
            return new UserProfileResponseGoal(source);
        }

        @Override
        public UserProfileResponseGoal[] newArray(int size) {
