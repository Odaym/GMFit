...
public class SlugBreakdownResponseYearly implements Parcelable {
  public static final Creator<SlugBreakdownResponseYearly> CREATOR =
      new Creator<SlugBreakdownResponseYearly>() {
        @Override public SlugBreakdownResponseYearly createFromParcel(Parcel in) {
          return new SlugBreakdownResponseYearly(in);
        }

        @Override public SlugBreakdownResponseYearly[] newArray(int size) {
