...
public class AuthenticationResponseChartData implements Parcelable {
    public static final Creator<AuthenticationResponseChartData> CREATOR = new Creator<AuthenticationResponseChartData>() {
        @Override
        public AuthenticationResponseChartData createFromParcel(Parcel in) {
            return new AuthenticationResponseChartData(in);
        }

        @Override
        public AuthenticationResponseChartData[] newArray(int size) {
