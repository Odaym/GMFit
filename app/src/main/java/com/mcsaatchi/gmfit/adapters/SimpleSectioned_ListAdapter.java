...
public class SimpleSectioned_ListAdapter extends BaseAdapter implements PinnedSectionListView.PinnedSectionListAdapter {
    ...
    public SimpleSectioned_ListAdapter(Context context, List<MealItem> mealItems) {
