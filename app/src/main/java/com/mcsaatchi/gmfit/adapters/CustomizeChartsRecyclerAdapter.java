...
import com.mcsaatchi.gmfit.touch_helpers.Drag_ItemTouchHelperAdapter;

import java.util.Collections;
import java.util.List;

public class CustomizeChartsRecyclerAdapter extends RecyclerView.Adapter<CustomizeChartsRecyclerAdapter.MyViewHolder> implements Drag_ItemTouchHelperAdapter {

    private List<DataChart> dataChartsMap;
    private int drawableResId;
    private String array_order_changed_event;

    public CustomizeChartsRecyclerAdapter(List<DataChart> dataChartsMap, int drawableResId, String array_order_changed_event) {
    ...
    public void onClearView() {
        EventBus_Singleton.getInstance().post(new EventBus_Poster(array_order_changed_event, dataChartsMap));
    }
