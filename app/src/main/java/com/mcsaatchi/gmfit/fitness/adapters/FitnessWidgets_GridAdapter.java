...
public class FitnessWidgets_GridAdapter
    extends RecyclerView.Adapter<FitnessWidgets_GridAdapter.RecyclerViewHolder> {
  private Context context;
  private ArrayList<FitnessWidget> widgetsMap;
  private int layoutResourceId;

  public FitnessWidgets_GridAdapter(Context context, ArrayList<FitnessWidget> widgets,
