package com.mcsaatchi.gmfit.services;
...
public class GoogleFit_Service extends IntentService {

    public static final String TAG = "GoogleFit_Service";
    private GoogleApiClient googleApiFitnessClient;
    private OnDataPointListener mListener;

    public static final String SERVICE_REQUEST_TYPE = "requestType";
    public static final int TYPE_BUILD_CLIENT = 1;
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG, "GoogleFit_Service created");
        buildFitnessClient();
    }

    @Override
    public void onDestroy() {
        Log.d(TAG, "GoogleFit_Service destroyed");
        if (googleApiFitnessClient.isConnected()) {
    ...
    public GoogleFit_Service() {
        super("GoogleFit_Service");
    }
    ...
    private void buildFitnessClient() {
        if (googleApiFitnessClient == null) {
            ...
            googleApiFitnessClient = new GoogleApiClient.Builder(this)
