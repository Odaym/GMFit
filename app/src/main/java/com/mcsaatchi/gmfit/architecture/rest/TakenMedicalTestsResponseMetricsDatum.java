...
public class TakenMedicalTestsResponseMetricsDatum implements Parcelable {
  public static final Creator<TakenMedicalTestsResponseMetricsDatum> CREATOR =
      new Creator<TakenMedicalTestsResponseMetricsDatum>() {
        @Override public TakenMedicalTestsResponseMetricsDatum createFromParcel(Parcel source) {
          return new TakenMedicalTestsResponseMetricsDatum(source);
        }

        @Override public TakenMedicalTestsResponseMetricsDatum[] newArray(int size) {
  ...
  @SerializedName("units") @Expose private List<TakenMedicalTestsResponseUnit> units =
      new ArrayList<>();
