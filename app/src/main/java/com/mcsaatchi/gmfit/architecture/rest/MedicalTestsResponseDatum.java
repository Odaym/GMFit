...
public class MedicalTestsResponseDatum implements Parcelable {
  public static final Creator<MedicalTestsResponseDatum> CREATOR =
      new Creator<MedicalTestsResponseDatum>() {
        @Override public MedicalTestsResponseDatum createFromParcel(Parcel source) {
          return new MedicalTestsResponseDatum(source);
        }

        @Override public MedicalTestsResponseDatum[] newArray(int size) {
  ...
  @SerializedName("units") @Expose private List<MedicalTestsResponseDatumUnit> units =
      new ArrayList<MedicalTestsResponseDatumUnit>();
