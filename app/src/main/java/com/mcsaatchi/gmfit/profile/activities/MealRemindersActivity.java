...
public class MealRemindersActivity extends BaseActivity {
  ...
  public static void setupMealRemindersAlarm(Context context, SharedPreferences prefs,
    ...
    //Concatenate the alarm instance ID to the final time of the alarm, so that it can be grabbed later
    switch (mealType) {
      case "Breakfast":
  ...
  @OnClick(R.id.breakfastReminderLayout) public void handleBreakfastReminderPress() {
    ...
    TimePickerDialog timePicker = new TimePickerDialog(MealRemindersActivity.this,
  ...
  private void cancelAllPendingAlarms() {
    ...
    PendingIntent lunchPendingAlarm =
        PendingIntent.getBroadcast(MealRemindersActivity.this, 1, intent,
            PendingIntent.FLAG_UPDATE_CURRENT);
    PendingIntent dinnerPendingAlarm =
        PendingIntent.getBroadcast(MealRemindersActivity.this, 2, intent,
            PendingIntent.FLAG_UPDATE_CURRENT);
