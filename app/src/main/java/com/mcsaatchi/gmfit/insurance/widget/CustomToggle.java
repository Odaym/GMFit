...
public class CustomToggle extends LinearLayout implements View.OnClickListener {
  ...
  @Override public void onClick(View view) {
    ...
    switch (view.getId()) {
      case R.id.containerOptionOne:
        ...
        containerOptionOne.setBackground(
            getResources().getDrawable(R.drawable.toggle_button_selected));
        toggleOptionOneTv.setTextColor(getResources().getColor(R.color.white));
        containerOptionTwo.setBackground(
            getResources().getDrawable(R.drawable.toggle_button_unselected));
  ...
  public void setUp(String toggleName, String optionOne, String optionTwo,
