...
public class MedicalInformationAdapter extends RecyclerView.Adapter<MedicalInformationAdapter.ViewHolder> {
    ...
    public MedicalInformationAdapter(List<MedicalInformationModel> medicines, MedicalInformationAdapter.OnClickListener onClickListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void addListener(final MedicalInformationModel medicine, final int position, final MedicalInformationAdapter.OnClickListener onClickListener) {
