...
public class StatusAdapter extends RecyclerView.Adapter<StatusAdapter.ViewHolder> {
    ...
    public StatusAdapter(List<ReimbursementModel> reimbursements, StatusAdapter.OnClickListener onClickListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void addListener(final ReimbursementModel reimbursement, final int position, final OnClickListener onClickListener) {
