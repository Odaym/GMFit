package com.mcsaatchi.gmfit.common;
...
public class Constants {
  ...
  public static final int WAIT_TIME_BEFORE_CHECKING_METRICS_SERVICE = 180000;
  ...
  public static final String EXTRAS_USER_PROFILE_USER_MEDICAL_CONDITION =
      "user_profile_user_medical_condition";
  public static final String EXTRAS_USER_PROFILE_USER_MEDICAL_CONDITION_ID =
      "user_profile_user_medical_condition_id";
  public static final String EXTRAS_USER_PROFILE_MEASUREMENT_SYSTEM =
      "user_profile_measurement_system";
  ...
  public static final String EXTRAS_USER_PROFILE_ACTIVITY_LEVEL_ID =
      "user_profile_activity_level_id";
